 ...
 * configured by {@link KafkaBotPublisherProperties#topic()} using a
...
public class KafkaBotUpdatePublisher implements BotUpdatePublisher {
    ...
    private final KafkaBotPublisherProperties properties;
    private final ObjectMapper objectMapper;

    public KafkaBotUpdatePublisher(BotKafkaTemplateProvider templateProvider,
                                   KafkaBotPublisherProperties properties,
