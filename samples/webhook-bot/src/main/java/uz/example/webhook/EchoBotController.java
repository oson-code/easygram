...
/**
 * Bot controller for handling user commands and messages in the webhook sample.
 * A simple echo bot that repeats messages back to users using webhook transport.
 *
 * @since 0.0.1
 */
@BotController
public class EchoBotController {
    ...
    public String onStart(User user) {
        return "Hello, " + user.getFirstName() + "! I am an echo bot using webhook. Send me any message and I will repeat it.\n\nUse /help to see available commands.";
    }
