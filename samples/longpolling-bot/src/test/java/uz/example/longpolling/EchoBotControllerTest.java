...
/**
 * Integration tests for {@link EchoBotController} in the longpolling-bot sample.
 */
class EchoBotControllerTest {
    ...
    void startCommand_returnsGreetingWithUserName() throws Exception {
        ...
        assertThat(firstText(response)).contains("Hello", "Alice");
    }
    ...
    void textMessage_echoesBackWithUserName() throws Exception {
        BotResponse response = dispatch("hello world");
        assertThat(firstText(response)).contains("Alice").contains("hello world");
    }
    ...
    void unknownUpdate_defaultHandlerFiresWithChatId() throws Exception {
        ...
        assertThat(msg.getText()).contains("Try /help");
    }
    ...
    private BotResponse dispatch(String text) throws Exception {
        ...
        runner.run(context -> {
            ...
            Update update = buildMessageUpdate(text, 42L, "Alice");
    ...
    static Update buildMessageUpdate(String text, long chatId, String firstName) {
        User user = mock(User.class);
