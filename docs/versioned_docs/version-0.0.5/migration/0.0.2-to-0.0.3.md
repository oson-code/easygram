---
id: 0.0.2-to-0.0.3
title: Migrating from 0.0.2 to 0.0.3
description: Migration guide from Easygram 0.0.2 to 0.0.3 — new filter pipeline, updated property keys, handler annotation changes, and step-by-step upgrade instructions.
keywords: [easygram migration 0.0.3, easygram upgrade, telegram bot framework version upgrade, easygram filter pipeline migration]
---
...
Version 0.0.3 adds **edit-message support** to all reply types, improves the markup system
