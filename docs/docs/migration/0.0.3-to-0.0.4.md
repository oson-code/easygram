---
id: 0.0.3-to-0.0.4
title: Migrating from 0.0.3 to 0.0.4
description: Migration guide from Easygram 0.0.3 to 0.0.4 — module splits, transport abstraction changes, updated property paths, and required dependency updates for the new architecture.
keywords: [easygram migration 0.0.4, easygram module split, telegram bot framework transport refactor, easygram 0.0.4 upgrade]
---
