...
:::note Removed in 0.0.7
`PlainTextTemplate` and `LocalizedTemplate` were removed in version 0.0.7.
Migrate to `PlainReply.of("text {0}", arg)` and `LocalizedReply.of("key", arg)`.
See the [0.0.6 → 0.0.7 migration guide](../../MIGRATION.md#006--007).
:::
