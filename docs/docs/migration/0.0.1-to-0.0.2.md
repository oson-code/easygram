...
description: Migration guide from Easygram 0.0.1 to 0.0.2 — breaking changes to handler annotations, updated dependency coordinates, and step-by-step upgrade instructions.
keywords: [easygram migration 0.0.2, easygram upgrade guide, telegram bot framework migration, easygram breaking changes]
---
...
| `@BotChatMemberUpdate` | `getChatMember()` | [handlers](../core-concepts/handlers#botchatmemberupdate) |
