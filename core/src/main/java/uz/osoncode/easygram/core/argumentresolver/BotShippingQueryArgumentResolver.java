...
/**
 * Argument resolver that injects the {@link ShippingQuery} from the current update.
 *
 * @author Islom Mirsaburov
 * @since 0.0.1
 */
public class BotShippingQueryArgumentResolver implements BotArgumentResolver {
